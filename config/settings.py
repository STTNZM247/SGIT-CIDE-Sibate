...
# Email transaccional
# - En hosting: SMTP Resend (plan pago PythonAnywhere tiene puertos abiertos).
# - En local sin variables: consola (sin necesitar credenciales).
...
DEFAULT_FROM_EMAIL = os.getenv(
    'DEFAULT_FROM_EMAIL',
    'Inventario SENA <onboarding@resend.dev>',
)
